...
public class Math {
    ...
    public static float vectorLen(float[] v) {
        return (float) java.lang.Math.sqrt(java.lang.Math.pow(v[0], 2)
                + java.lang.Math.pow(v[1], 2) + java.lang.Math.pow(v[2], 2));
    }
    ...
    public static float vectorLen(Vector<Float> v) {
        return (float) java.lang.Math.sqrt(java.lang.Math.pow(v.get(0), 2)
                + java.lang.Math.pow(v.get(1), 2) + java.lang.Math.pow(v.get(2), 2));
    }
    ...
    public static float angleBetweenVectors(Vector<Float> v1, Vector<Float> v2) {
        ...
        return (float) (java.lang.Math.acos(cosAngle) * (180 / java.lang.Math.PI));
    }
