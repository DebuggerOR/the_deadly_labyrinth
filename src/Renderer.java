...
public class Renderer implements GLEventListener {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        switch (levelDraw) {
            case 1: {
                mazeCells = MazeCreator.MakeMaze("maze_layout_1");
                playerPos.resetAxis();
                levelDraw = 0;
                break;
            }
            case 2: {
                mazeCells = MazeCreator.MakeMaze("maze_layout_2");
                playerPos.resetAxis();
                levelDraw = 0;
                break;
            }
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        playerPos = new PlayerAxis(0.02f, 2.0f);
    ...
    private float jump(float eyey) {
        ...
        if (jumpState == PlayerState.JUMPING_UP) {
            ...
            if (eyey + jumpValue + 0.05f < playerFloor) {
                jumpState = PlayerState.WALKING;
            }
        }
        return jumpValue;
    }
